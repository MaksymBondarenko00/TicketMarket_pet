package com.example.ticketmarket_pet.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(public * com.example.ticketmarket_pet.controller.*.*(..))")
    public void controllerLog() {
    }

    @Pointcut("execution(public * com.example.ticketmarket_pet.services.*.*(..))")
