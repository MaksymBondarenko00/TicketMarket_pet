...
INSERT INTO concerts(concert_id, concert_name, country, city, address, tickets_count)
VALUES (CAST('ea7d23ec91f34b6c9692e3d1dc51d7fb' AS BINARY(16)), 'Concert1', 'USA', 'New York', '123 Broadway', 1000),
       ...
       (CAST('e4f8ed9e3c5f476d8cb75cddcf8c24d2' AS BINARY(16)), 'Concert4', 'Australia', 'Sydney', '101 George St',
        1500),
       (CAST('93ae1eaa65094d46b41f2a73e92d1e37' AS BINARY(16)), 'Concert5', 'Germany', 'Berlin', '202 Alexanderplatz',
        900);
...
INSERT INTO orders(order_id, client_id, order_cost, promo_code, payment_method, currency_code,
                   created_at)
VALUES (CAST('70f8a1dc8f914f24bc3aa9bb29292482' AS BINARY(16)), 1, 100.00,
        CAST('7d3e8918ecf74e8a9e5cf1045d2c4a19' AS BINARY(16)), 'Credit Card',
        'EUR', NOW()),
       (CAST('e4b4f7aaefa740c08e63a3fbc5c8a0c7' AS BINARY(16)), 2, 50.00,
        CAST('9bf6d26b5937485896e2a3fe8e8cbf0d' AS BINARY(16)), 'PayPal', 'USD',
        NOW()),
       (CAST('dd77d18ae178490d8a4b6d3c747d469f' AS BINARY(16)), 3, 75.00, NULL, 'Credit Card', 'UA', NOW()),
       (CAST('8a0cbb1c1b6f47a6b92125382c7f4fd1' AS BINARY(16)), 4, 120.00, NULL, 'Credit Card', 'USD', NOW()),
       (CAST('eb7c2ab3e99941569ee2b3b08b646e5a' AS BINARY(16)), 5, 90.00,
